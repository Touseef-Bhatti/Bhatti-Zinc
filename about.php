...
<section class="cta-banner">
    <div class="container">
        <div class="cta-inner reveal">
            <div class="eyebrow"><span class="label">Work With Us</span></div>
            <h2 class="cta-title">Partner with a<br><em>zinc specialist</em></h2>
            <p class="cta-sub">Whether you are a first-time importer or an established trade partner, our team is ready to support your procurement needs.</p>
            <div class="cta-actions">
                <a href="contact.php" class="btn btn--luxury-outline ">Contact Our Team</a>
